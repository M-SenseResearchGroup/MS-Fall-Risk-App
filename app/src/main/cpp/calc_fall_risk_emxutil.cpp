...
{
  emxFreeStruct_cell_wrap_26(&pMatrix[0]);
  emxFreeStruct_cell_wrap_26(&pMatrix[1]);
}

void emxFreeMatrix_cell_wrap_261(cell_wrap_26 pMatrix[3])
{
  emxFreeStruct_cell_wrap_26(&pMatrix[0]);
  emxFreeStruct_cell_wrap_26(&pMatrix[1]);
  emxFreeStruct_cell_wrap_26(&pMatrix[2]);
}
...
{
  emxInitStruct_cell_wrap_26(&pMatrix[0]);
  emxInitStruct_cell_wrap_26(&pMatrix[1]);
}

void emxInitMatrix_cell_wrap_261(cell_wrap_26 pMatrix[3])
{
  emxInitStruct_cell_wrap_26(&pMatrix[0]);
  emxInitStruct_cell_wrap_26(&pMatrix[1]);
  emxInitStruct_cell_wrap_26(&pMatrix[2]);
}
...
/* End of code generation (calc_fall_risk_emxutil.cpp) */
