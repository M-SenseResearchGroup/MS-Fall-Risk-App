...
static void emxInitStruct_cell_wrap_43(cell_wrap_43 *pStruct);
...
void emxFreeMatrix_cell_wrap_43(cell_wrap_43 pMatrix[3])
{
  emxFreeStruct_cell_wrap_43(&pMatrix[0]);
  emxFreeStruct_cell_wrap_43(&pMatrix[1]);
  emxFreeStruct_cell_wrap_43(&pMatrix[2]);
}
...
void emxInitMatrix_cell_wrap_43(cell_wrap_43 pMatrix[3])
{
  emxInitStruct_cell_wrap_43(&pMatrix[0]);
  emxInitStruct_cell_wrap_43(&pMatrix[1]);
  emxInitStruct_cell_wrap_43(&pMatrix[2]);
}
...
/* End of code generation (getFallClass_emxutil.c) */
